...
public class TrackFragmentTest {
  ...
  public void renderSessionTimings(){
    ...
    Session session1 = new Session("Craft", "Try your hand at craft", parseDate("2016-09-24T03:30:00+05:30"), parseDate("2016-09-24T04:30:00+05:30"), Category.BELONG, "Ballroom");
